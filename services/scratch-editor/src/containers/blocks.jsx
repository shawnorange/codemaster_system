...
class Blocks extends React.Component {
    ...
    componentDidMount () {
        ...
        this.workspace.addChangeListener(this.handleDashimaWorkspaceChange);
    ...
    componentWillUnmount () {
        this.detachVM();
        this.unmounted = true;
        this.workspace.removeChangeListener(this.handleDashimaWorkspaceChange);
    ...
    handleDashimaWorkspaceChange (event) {
        DashimaLearningEventRecorder.recordBlocklyEvent(event, this.props.vm);
    }
