...
QWEN_BASE_URL = get_env(
    "QWEN_BASE_URL",
    default="https://dashscope.aliyuncs.com/compatible-mode/v1",
)
QWEN_OCR_MODEL = get_env("QWEN_OCR_MODEL", default="qwen3.6-plus")
QWEN_OCR_ENABLE_THINKING = get_env_bool("QWEN_OCR_ENABLE_THINKING", default=False)
QWEN_TEMPERATURE = get_env_float("QWEN_TEMPERATURE", default=0.0)
QWEN_TOP_P = get_env_float("QWEN_TOP_P", default=0.1)
QWEN_TIMEOUT_SECONDS = get_env_int("QWEN_TIMEOUT_SECONDS", default=180)
QWEN_MAX_RETRIES = get_env_int("QWEN_MAX_RETRIES", default=3)
EXAM_PDF_RENDER_DPI = get_env_int("EXAM_PDF_RENDER_DPI", default=300)
EXAM_QWEN_OCR_CONCURRENCY = get_env_int("EXAM_QWEN_OCR_CONCURRENCY", default=2)
HOMEWORK_LLM_MODEL = get_env("HOMEWORK_LLM_MODEL", default="qwen3.6-plus")
HOMEWORK_LLM_API_URL = get_env(
    "HOMEWORK_LLM_API_URL",
    default="https://dashscope.aliyuncs.com/compatible-mode/v1",
)
HOMEWORK_LLM_TIMEOUT_SECONDS = get_env_int("HOMEWORK_LLM_TIMEOUT_SECONDS", default=60)
HOMEWORK_LLM_MAX_RETRIES = get_env_int("HOMEWORK_LLM_MAX_RETRIES", default=0)
HOMEWORK_LLM_RETRY_BACKOFF_SECONDS = get_env_float("HOMEWORK_LLM_RETRY_BACKOFF_SECONDS", default=1.0)
HOMEWORK_LLM_TEXT_BLOCK_MAX_CHARS = get_env_int("HOMEWORK_LLM_TEXT_BLOCK_MAX_CHARS", default=500)
HOMEWORK_IMPORT_SUPPLEMENT_MISSING_ANSWERS = get_env_bool("HOMEWORK_IMPORT_SUPPLEMENT_MISSING_ANSWERS", default=True)
...
HOMEWORK_IMPORT_STALE_MINUTES = get_env_int("HOMEWORK_IMPORT_STALE_MINUTES", default=30)
